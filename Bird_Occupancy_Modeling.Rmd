...
bird.counts$brd_perpoint %>%
  ...
  ylim(0, 4000) + 
  labs(
    title = "Distribution of Observations Over Time (Perpoint)",
    x = "Year",
...
ggplot(missing_df, aes(x = reorder(column, -missing_percent), y = missing_percent)) +
  ...
  labs(
    title = "Percentage of Missing Data by Column (Perpoint)",
    x = "Column",
    y = "Missing Data (%)"
  ) +
  theme_minimal() +
...
ggplot(bird.counts$brd_perpoint, aes(x = siteID)) +
  geom_bar() +
  labs(title = "Distribution of Observations by Site (Perpoint)", x = "Site ID", y = "Count") +
...
bird.counts$brd_countdata %>%
  ...
  geom_bar(fill = "steelblue") +
  labs(
    title = "Distribution of Observations Over Time (CountData)",
    x = "Year",
    y = "Number of Observations"
  ) +
  theme_minimal()
...
ggplot(missing_df, aes(x = reorder(column, -missing_percent), y = missing_percent)) +
  geom_bar(stat = "identity", fill = "tomato") +
  labs(
    title = "Percentage of Missing Data by Column (CountData)",
    x = "Column",
    y = "Missing Data (%)"
  ) +
  theme_minimal() +
...
ggplot(bird.counts$brd_countdata, aes(x = siteID)) +
  geom_bar() +
  labs(title = "Distribution of Observations by Site (CountData)", x = "Site ID", y = "Count") +
  theme(axis.text.x = element_text(angle = 90))
```
