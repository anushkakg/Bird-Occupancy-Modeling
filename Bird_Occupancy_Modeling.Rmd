...
* Understand occupancy modeling and its uses.
* Perform occupancy modeling using NEON breeding landbird data.
...
### Install R Packages
* RPresence: `install.packages('RPresence',repo='https://www.mbr-pwrc.usgs.gov/mbrCRAN')`
